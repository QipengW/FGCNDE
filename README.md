...
We saved the parameters of the FGCNDE model after running on the three data sets in the a folder, and we can directly use our trained parameters to display the results in our article.
